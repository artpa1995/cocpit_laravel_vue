<template>
  <div>
    <h1 class="text-center my-5 text-4xl">Login</h1>
  ...
  export default {
    ...
    methods: {
      ...
      login() {
        ...
        // console.log(this.email, this.password);return
        axios.post('/login', {
          email: this.email,
